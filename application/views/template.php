...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #003b6f">
    ...
    <a href="#" class="brand-link " >
      <img src="<?=base_url('assets/')?>img/walikota-logo.png" alt="Logo <?=$web->nama?>" class="brand-image elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a class="d-block"><small>User login :</small><br> <b><?=$this->session->userdata('nama')?> ( <?=$this->session->userdata('level')?> )</b></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url($this->session->userdata('level'))?>/absensi_pegawai" class="nav-link">
                  <i class="far fa-file nav-icon"></i>
                  <p>Absensi</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?=base_url($this->session->userdata('level'))?>/ganti_password" class="nav-link">
